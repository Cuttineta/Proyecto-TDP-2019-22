...
public class CampoDeMuerte extends PowerUp {
	...
	public void actuar() {
		for (Aliado aliado : mapa.getMapa().getAliados()) {
			...
			if (aliado != personaje && this.getPosicionY() == aliado.getPosicionY()
					&& this.getPosicionX() - aliado.getPosicionX() <= 50
		...
		for (Enemigo enemigo : mapa.getMapa().getEnemigos()) {
			...
			if (enemigo != personaje && this.getPosicionY() == enemigo.getPosicionY()
					&& enemigo.getPosicionX() - this.getPosicionX() <= 50
