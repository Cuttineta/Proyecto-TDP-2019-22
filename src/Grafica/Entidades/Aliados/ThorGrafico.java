...
public class ThorGrafico extends AliadoGrafico{
	private String palabras[]= {"estatico","estatico","estatico"};

	public ThorGrafico(int x, int y,PanelMapa m,Entidad e) {
		super(x,y,m,e);
		graficos=new ImageIcon[3];
		
		for(int i=0;i<palabras.length;i++) {
			graficos[i]=new ImageIcon("SpritesAvengers/Aliados/Thor/"+ palabras[i]+".png");
		}
