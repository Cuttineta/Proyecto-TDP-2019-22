...
public class HawkeyeGrafico extends AliadoGrafico{
	private String palabras[]= {"estatico","estatico","estatico"};

	public HawkeyeGrafico(int x, int y,PanelMapa m,Entidad e) {
		super(x,y,m,e);
		graficos=new ImageIcon[3];
		
		for(int i=0;i<palabras.length;i++) {
			graficos[i]=new ImageIcon("SpritesAvengers/Aliados/Hawkeye/"+ palabras[i]+".png");
		}
